...
回転速度や初期状態(VRChatにおけるワールド読み込み直後)の回転角度の指定もできます。
...
2.X-Axis RotationやX-Axis Rotation SpeedやX-Axis Default Degreeなどのパラメーターを調整する
...
[更新履歴]
2019/04/30 ver1.02 微調整及び最適化
2019/04/22 ver1.01 Unity上で表示されるShader名の変更
2019/04/xx ver1.00
